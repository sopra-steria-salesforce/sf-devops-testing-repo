...
1. Initialise repo
    ...
    - The last step! This step will automatically set labels, settings, rulesets, create first GitHub release, Salesforce Unlocked Package and create preprod branch
